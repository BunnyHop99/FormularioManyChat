...
export class DataService {
  ...
  //check number raffle
  async checkNumberRaffle(phone: string, res:any): Promise<boolean> {
  ...
  //check phone number
  async checkNumber(phone: String, res:any): Promise<boolean> {
    return await this.db
      .collection('restaurants')
      .doc(res)
  ...
  async writeClientRaffleData(phone: string, mes:any, dia:any,anho:any, res:any): Promise<string> {
  ...
  //write client
  async writeClientData(nombre: any, apellido: any, correo: any, telefono: any, mes: any, dia: any, anho: any, res:any): Promise<any> {
    let name = nombre;
    ...
    let timestamp =  date;
    let fb:boolean = true;
    let idunico:string = Math.random().toString();
   
    let data = { name, lastName, email, phone, birthday, timestamp, fb, idunico}
    return await this.db
      .collection('restaurants')
      .doc(res)
      .collection('clients')
